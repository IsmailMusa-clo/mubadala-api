        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @can('عرض الصلاحيات')
                    <a class="btn btn-primary" href="{{route('permissions.index')}}"> رجوع</a>
                    @endcan
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" onclick="update('{{$permission->id}}')"
...
<script>
    function update(permissionId){
        axios.put(`/dashboard/permissions/${permissionId}`,{
