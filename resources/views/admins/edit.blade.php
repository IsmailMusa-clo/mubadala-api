                        ...
                        <form class="row g-3">
                            <div class="col-md-12">
                                ...
                                <select class="form-select" id="role_id">
                                    ...
                                    <option value="{{ $role->id }}" @if ($myRole?->id == $role->id)
                                        selected
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name"
                                        value="{{ old('name', $admin->name) }}" placeholder="ادخل الاسم" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="email"
                                        value="{{old('email', $admin->email)}}" placeholder="ادخل الايميل" />
                                </div>
                            </div>
                            <div class="col-12">
                                <button class="btn btn-primary" type="button" onclick="update('{{$admin->id}}')">
                                    تعديل
                                </button>
                            </div>
                        </form>
...
<script>
    ...
    axios.put(`/dashboard/admins/${adminId}`, {
        name,
        email,
        role_id
    })
